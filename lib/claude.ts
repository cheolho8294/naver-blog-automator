...
- notes: 1인칭. 입고→전처리→메인→마무리 흐름에 맞는 현장 체감 3~6문장. 사진·메모 우선. 흔한 오염·스월·미세 스크래치 수준은 자연스럽게 가능. 깊은 손상·PPF·코팅 박리 등은 보일 때만. 완벽·신차급 표현 금지.
...
[작업 후기 · 현장 서술]
- 사진·사용자 메모 중심의 작업 후기. 흔한 오염·스월·미세 스크래치는 자연스럽게 가능.
- 깊은 스크래치·재도장·PPF손상·코팅박리·사고흔적·알칸타라/카본/무광PPF → 사진·메모 있을 때만.
- 결과: 완벽 제거·신차급·완전 복원 금지 / 눈에 띄게 개선·광택 회복·스월 감소·반사감 선명 등.
- 흐름: 입고·상태확인 → 세차·전처리 → 메인작업 → 마무리 → 최종결과. 디테일러→고객 설명 톤.
- 시간·RPM·희석·코팅지속·관리주기 등 수치는 실제 정보 있을 때만. 현장에서 말 못 할 문장은 쓰지 말 것.
