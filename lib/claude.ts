...
- notes: 1인칭. 입고→전처리→메인→마무리 흐름. **관찰**(어디에 무엇이 보였는지)·**왜 그렇게 했는지**·현장 체감 1~2문장. 「일반적으로/보통」 위주 설명 금지. 사진·메모 우선.
