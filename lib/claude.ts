...
- notes: 1인칭. 현장 순서·압력/속도감·시간·실수 방지 같은 노하우 3~6문장. 메모·사진에 보이는 것만 구체적으로. 과장·광고체 금지.
- comparison: "시공 전 vs 시공 후" 또는 "기존 vs 이번" 한두 문장. 사진·메모 근거.
- 사진에 보이지 않는 작업·제품·소재·장비는 추측하지 말 것. 불명확하면 보수적 표현.
- JSON 외 텍스트 금지.`;
